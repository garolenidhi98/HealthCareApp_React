  ...
  return (
    <div className="footer-section">
      ...
      <div className="ft-copyright">
        <p>© 2015-2025 Precision Health Hub. All rights reserved.</p>

        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/nidhi-garole-81524521a/"
              title="LinkedIn"
              target="_blank"
          ...
          {/* <li>
            <a
              href="https://github.com/garolenidhi98"
              title="GitHub"
              target="_blank"
              rel="noopener noreferrer"
            >
